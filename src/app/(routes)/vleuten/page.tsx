...
export const metadata: Metadata = {
  ...
  description: "Professionele website laten maken in Vleuten. Responsive, snel en SEO-klaar, met direct contact met de developer. WordPress en maatwerk. Vraag een offerte aan.",
