...
export const metadata: Metadata = {
  ...
  description: "Laat je professionele website maken in Vleuten. 12+ jaar ervaring, moderne technologie, scherpe prijzen. WordPress, Next.js, SEO-geoptimaliseerd.",
  keywords: ["website laten maken vleuten", "webdesign vleuten"],
        ...
        <nav className="py-4 bg-slate-50 border-b border-slate-200">
          <div className="max-w-6xl mx-auto px-6">
            <ol className="flex items-center gap-2 text-sm">
              ...
              <li><span className="text-slate-900">Vleuten</span></li>
            </ol>
          </div>
        </nav>
          ...
          <div className="max-w-6xl mx-auto px-6">
            <div className="max-w-3xl">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-slate-900 mb-6">
                Website Laten Maken{" "}
                <span className="bg-gradient-to-r from-[#0f766e] to-[#14b8a6] bg-clip-text text-transparent">Vleuten</span>
              </h1>
              
              <p className="text-xl text-slate-600 mb-8">
                Webdeveloper in Vleuten met expertise in moderne websites, webshops en SEO. 
                Persoonlijk, snel en resultaatgericht.
              </p>
