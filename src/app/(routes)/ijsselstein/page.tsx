...
export const metadata: Metadata = {
  ...
  keywords: ["website laten maken ijsselstein", "webdesign ijsselstein", "wordpress ijsselstein", "goedkope website ijsselstein", "website bouwen ijsselstein"],
  alternates: {
    canonical: "https://techsolutionsutrecht.nl/ijsselstein",
  },
  openGraph: {
    title: "Website Laten Maken IJsselstein | Vanaf €250",
    description: "Professionele WordPress websites in IJsselstein. Snel, goedkoop en betrouwbaar. Vanaf €250 binnen 1 week online.",
  ...
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 bg-orange-500/20 text-orange-400 px-4 py-2 rounded-full text-sm font-medium mb-6">
              ...
              <span>IJsselstein & Omgeving</span>
            </div>
            ...
            <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
              Professionele WordPress websites voor ondernemers in IJsselstein. 
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4">Waarom Ondernemers in IJsselstein voor Ons Kiezen</h2>
            
            <p className="text-muted-foreground max-w-2xl mx-auto">
              IJsselstein is een historische stad met een bloeiend ondernemersklimaat. 
              Van het centrum rond de Sint-Nicolaaskerk tot de wijken rondom — 
              wij helpen je met een professionele website.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              },
              {
                ...
                description: "Wij kennen IJsselstein en de ondernemers hier. Persoonlijk contact.",
                icon: "🎯"
              },
              {
                title: "Alles in 1",
      ...
      <section className="py-16 bg-muted/30">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4">Onze Diensten in IJsselstein</h2>
            ...
            <Card className="border border-border/50">
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground mb-4">
                  Professionele websites voor ZZP'ers en kleine bedrijven in IJsselstein. 
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl font-bold mb-6">Website Laten Maken in IJsselstein</h2>
              
              <p className="text-muted-foreground mb-4">
                IJsselstein is een historische stad met een rijk verleden. 
                Met het karakteristieke centrum rond de Sint-Nicolaaskerk, 
                winkelcentrum Eiteren, en woonwijken als Zenderveen en Arkelsteen — 
                er is veel diversiteit in het bedrijfsleven.
              </p>
              
              <p className="text-muted-foreground mb-4">
                Als tech-partner helpen wij ondernemers in IJsselstein met een professionele 
                online presence. Of je nu een startende ZZP'er bent of een gevestigd bedrijf, 
                wij maken een website die bij jou past.
              </p>
              
              <p className="text-muted-foreground mb-6">
                Onze klanten in IJsselstein waarderen vooral onze snelle service, 
                scherpe prijzen en het feit dat we ook tech reparaties doen. 
                Eén aanspreekpunt voor al je tech-vragen.
              </p>
              
              <div className="flex flex-wrap gap-2">
                {["Centrum", "Eiteren", "Zenderveen", "Arkelsteen", "Binnenstad"].map((area) => (
            ...
            <Card className="border border-border/50">
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground mb-4 italic">
                  ...
                  Nu ook mijn website door ze laten maken!"
                </p>
                
                <p className="font-semibold">Peter</p>
                <p className="text-sm text-muted-foreground">Nieuwegein</p>
              </CardContent>
            </Card>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="space-y-6">
              {[
                {
                  q: "Wat kost een website laten maken in IJsselstein?",
                ...
                {
                  q: "Kom je ook langs in IJsselstein?",
                  a: "Ja, we bedienen de hele regio Utrecht inclusief IJsselstein. Afhankelijk van het project kunnen we langs komen of werken we op afstand via video-bellen. Voor reparaties kun je bij ons terecht in Utrecht of we kunnen ophalen."
                },
                {
      ...
      <section className="py-16 bg-gradient-to-r from-orange-500/20 to-purple-500/20">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-4">Klaar voor Jouw Nieuwe Website in IJsselstein?</h2>
