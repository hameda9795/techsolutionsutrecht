...
export const metadata: Metadata = {
  ...
  keywords: ["website laten maken houten", "webdesign houten", "wordpress houten", "goedkope website houten", "website bouwen houten"],
  alternates: {
    canonical: "https://techsolutionsutrecht.nl/houten",
  },
  openGraph: {
    title: "Website Laten Maken Houten | Vanaf €250",
    description: "Professionele WordPress websites in Houten. Snel, goedkoop en betrouwbaar. Vanaf €250 binnen 1 week online.",
  ...
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
              Professionele WordPress websites voor ondernemers in Houten. 
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4">Waarom Ondernemers in Houten voor Ons Kiezen</h2>
            
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Houten groeit snel en dat zie je aan het ondernemerschap. 
              Wij helpen ondernemers in alle wijken — van Het Oude Dorp tot De Kruidenbuurt — 
              met een professionele website die scoort.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              },
              {
                ...
                description: "Wij kennen Houten en de ondernemers hier. Persoonlijk contact.",
                icon: "🎯"
              },
              {
                title: "Alles in 1",
      ...
      <section className="py-16 bg-muted/30">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4">Onze Diensten in Houten</h2>
            ...
            <Card className="border border-border/50">
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground mb-4">
                  Professionele websites voor ZZP'ers en kleine bedrijven in Houten. 
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl font-bold mb-6">Website Laten Maken in Houten</h2>
              
              <p className="text-muted-foreground mb-4">
                Houten is een van de snelst groeiende gemeenten van Nederland. 
                Met wijken als Het Oude Dorp, De Kruidenbuurt, De Akkers, en De Meerstede 
                is er veel diversiteit in het bedrijfsleven.
              </p>
              
              <p className="text-muted-foreground mb-4">
                Als tech-partner helpen wij ondernemers in Houten met een professionele 
                online presence. Of je nu een startende ZZP'er bent of een gevestigd bedrijf, 
                wij maken een website die bij jou past.
              </p>
              
              <p className="text-muted-foreground mb-6">
                Onze klanten in Houten waarderen vooral onze snelle service, 
                scherpe prijzen en het feit dat we ook tech reparaties doen. 
                Eén aanspreekpunt voor al je tech-vragen.
              </p>
              
              <div className="flex flex-wrap gap-2">
                {["Het Oude Dorp", "De Kruidenbuurt", "De Akkers", "De Meerstede", "De Polder"].map((area) => (
            ...
            <Card className="border border-border/50">
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground mb-4 italic">
                  ...
                  Aanrader voor iedereen in Houten!"
                </p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="space-y-6">
              {[
                {
                  q: "Wat kost een website laten maken in Houten?",
                ...
                {
                  q: "Kom je ook langs in Houten?",
                  a: "Ja, we bedienen de hele regio Utrecht inclusief Houten. Afhankelijk van het project kunnen we langs komen of werken we op afstand via video-bellen. Voor reparaties kun je bij ons terecht in Utrecht of we kunnen ophalen."
                },
                {
      ...
      <section className="py-16 bg-gradient-to-r from-orange-500/20 to-purple-500/20">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-4">Klaar voor Jouw Nieuwe Website in Houten?</h2>
