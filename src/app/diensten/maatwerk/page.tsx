      ...
      <nav className="py-4 bg-[var(--bg-secondary)] border-b border-[var(--border)]">
        <div className="container-custom">
          <ol className="flex items-center gap-2 text-sm flex-wrap">
            ...
            <li className="text-[var(--text-muted)]">/</li>
            <li><span className="text-[var(--text-primary)] font-medium capitalize">maatwerk</span></li>
          </ol>
        </div>
      </nav>
      ...
      <main className="pt-32 pb-24">
        <div className="container-custom">
          ...
          <section className="mt-20 max-w-3xl">
            <h2 className="text-3xl font-bold text-[var(--text-primary)] mb-6">Zo pakken we je project aan</h2>
          ...
          <section className="mt-20">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <Link href="/diensten/wordpress" className="card-service block p-6 rounded-2xl bg-[var(--bg-card)] border border-[var(--border)] hover:border-primary/40 transition-colors">
                ...
                <p className="text-[var(--text-secondary)] text-sm">Een professionele website die je zelf beheert.</p>
              </Link>
              <Link href="/diensten/webshop" className="card-service block p-6 rounded-2xl bg-[var(--bg-card)] border border-[var(--border)] hover:border-primary/40 transition-colors">
                ...
                <p className="text-[var(--text-secondary)] text-sm">Een complete WooCommerce-webshop, klaar om te verkopen.</p>
              </Link>
              <Link href="/portfolio" className="card-service block p-6 rounded-2xl bg-[var(--bg-card)] border border-[var(--border)] hover:border-primary/40 transition-colors">
                ...
                <p className="text-[var(--text-secondary)] text-sm">Bekijk eerder gebouwde projecten en applicaties.</p>
              </Link>
            </div>
          </section>
          ...
          {/* FAQ */}
          <section className="mt-20 max-w-3xl">
            <h2 className="text-3xl font-bold text-[var(--text-primary)] mb-10">Veelgestelde vragen over maatwerk</h2>
          ...
          <section className="mt-20 text-center bg-[var(--bg-card)] border border-[var(--border)] rounded-2xl p-10">
            <h2 className="text-3xl font-bold text-[var(--text-primary)] mb-4">Een idee voor maatwerk?</h2>
