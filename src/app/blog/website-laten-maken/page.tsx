        ...
        <nav className="py-4 bg-[var(--bg-secondary)] border-b border-[var(--border)]">
          <div className="container-custom">
            <ol className="flex items-center gap-2 text-sm flex-wrap">
              <li>
                <Link href="/" className="text-[var(--text-muted)] hover:text-primary transition-colors">
                  Home
                </Link>
              </li>
              <li className="text-[var(--text-muted)]">/</li>
              <li>
                <Link href="/blog" className="text-[var(--text-muted)] hover:text-primary transition-colors">
                  Blog
                </Link>
              </li>
              <li className="text-[var(--text-muted)]">/</li>
              <li>
                <span className="text-[var(--text-primary)] font-medium">Website laten maken</span>
              </li>
            </ol>
          </div>
        </nav>
        ...
        <div className="container-custom pt-8">
          <div className="max-w-3xl mx-auto">
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-[var(--text-primary)] mb-6">
              ...
              <span className="gradient-text">Kosten, Tijdlijn en Complete Gids</span>
            </h1>
            ...
            <div className="border-t border-[var(--border)] pt-12">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <Link
                  ...
                  className="p-6 bg-[var(--bg-card)] border border-[var(--border)] rounded-xl hover:border-primary transition-colors md:col-span-2"
                >
