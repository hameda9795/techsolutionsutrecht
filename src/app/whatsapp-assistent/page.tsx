      ...
      <nav className="py-4 bg-[var(--bg-secondary)] border-b border-[var(--border)]">
        <div className="container-custom">
          <ol className="flex items-center gap-2 text-sm flex-wrap">
            ...
            <li className="text-[var(--text-muted)]">/</li>
            <li><span className="text-[var(--text-primary)] font-medium">WhatsApp AI-assistent</span></li>
          </ol>
        </div>
      </nav>
      ...
      <main className="pt-12 pb-24">
        <div className="container-custom">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-[var(--text-secondary)] mb-8">
                Een slimme assistent die <strong className="text-[var(--text-primary)]">24/7 je klanten te woord staat
          ...
          <section className="mt-20">
            <h2 className="text-3xl font-bold text-[var(--text-primary)] mb-10">In 3 stappen live</h2>
            <div className="grid md:grid-cols-3 gap-6">
              {steps.map((s) => (
                <div key={s.title} className="bg-[var(--bg-card)] border border-[var(--border)] rounded-2xl p-6">
                  ...
                  <p className="text-[var(--text-secondary)] leading-relaxed">{s.text}</p>
                </div>
              ))}
            </div>
          </section>
          ...
          {/* Per branche */}
          <section className="mt-20">
            <h2 className="text-3xl font-bold text-[var(--text-primary)] mb-4">Voor elke branche op maat</h2>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {branches.map((b) => (
                <div key={b.title} className="bg-[var(--bg-card)] border border-[var(--border)] rounded-2xl p-6">
                  <div className="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-primary/10 mb-4">
                    <b.icon className="w-6 h-6 text-primary" />
                  </div>
                  <h3 className="text-xl font-bold text-[var(--text-primary)] mb-2">{b.title}</h3>
                  <p className="text-[var(--text-secondary)] leading-relaxed">{b.text}</p>
                </div>
              ))}
            </div>
          </section>
          ...
          {/* Features */}
          <section className="mt-20">
            <h2 className="text-3xl font-bold text-[var(--text-primary)] mb-10">Alles wat de assistent kan</h2>
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {features.map((f) => (
                <div key={f.title} className="flex gap-4 bg-[var(--bg-card)] border border-[var(--border)] rounded-xl p-5">
                  ...
                  <div>
                    ...
                    <p className="text-[var(--text-secondary)] text-sm leading-relaxed">{f.text}</p>
                  </div>
                </div>
              ))}
            </div>
          ...
          <section className="mt-20 max-w-3xl">
            <h2 className="text-3xl font-bold text-[var(--text-primary)] mb-6">Veilig en op je eigen nummer</h2>
            <p className="text-[var(--text-secondary)] mb-4 leading-relaxed">
          ...
          {/* Interne links */}
          <section className="mt-20">
            <h2 className="text-3xl font-bold text-[var(--text-primary)] mb-4">Past dit bij jouw plannen?</h2>
            <div className="grid md:grid-cols-3 gap-6">
              <Link href="/diensten/ai" className="card-service block p-6 rounded-2xl bg-[var(--bg-card)] border border-[var(--border)] hover:border-primary/40 transition-colors">
                <h3 className="text-lg font-bold text-[var(--text-primary)] mb-2">AI-integraties & chatbots</h3>
                <p className="text-[var(--text-secondary)] text-sm">Maatwerk AI-oplossingen voor je website of werkproces.</p>
              </Link>
              <Link href="/diensten/website-onderhoud" className="card-service block p-6 rounded-2xl bg-[var(--bg-card)] border border-[var(--border)] hover:border-primary/40 transition-colors">
                <h3 className="text-lg font-bold text-[var(--text-primary)] mb-2">Website laten maken</h3>
                <p className="text-[var(--text-secondary)] text-sm">Een professionele website naast je WhatsApp-assistent.</p>
              </Link>
              <Link href="/contact" className="card-service block p-6 rounded-2xl bg-[var(--bg-card)] border border-[var(--border)] hover:border-primary/40 transition-colors">
                <h3 className="text-lg font-bold text-[var(--text-primary)] mb-2">Direct contact</h3>
                <p className="text-[var(--text-secondary)] text-sm">Bespreek je situatie en krijg een eerlijk advies.</p>
              </Link>
            </div>
          </section>
          ...
          {/* FAQ */}
          <section className="mt-20 max-w-3xl">
            <h2 className="text-3xl font-bold text-[var(--text-primary)] mb-10">Veelgestelde vragen</h2>
